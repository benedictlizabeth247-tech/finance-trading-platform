    ...
    return (
      <main className="min-h-screen flex flex-col bg-white">
        <div className="flex-1 flex flex-col items-center justify-center p-8 text-center">
          ...
          <p className="text-[15px] text-gray-500 mb-12">Your request is with nexMonie operations. The data will be fulfilled from the admin dashboard and your request status will be updated.</p>
