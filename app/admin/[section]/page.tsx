...
const sources: Record<string, string> = { orders: "orders", deposits: "deposits", withdrawals: "withdrawals", transfers: "sends", payments: "payments", "audit-log": "ledger", "data-purchases": "data", p2p: "sends", users: "users", wallets: "wallets", allocations: "allocations" }
