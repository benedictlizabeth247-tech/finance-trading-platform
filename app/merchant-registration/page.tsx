...
export default function MerchantRegistration() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      // Simulate instant approval for Demo flow
      await merchantService.createProfile(user.id, nickname, selectedTier)
      await p2pService.seedInitialMarketplace(user.id, nickname)
